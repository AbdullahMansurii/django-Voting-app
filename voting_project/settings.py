...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-26_per(*cxgy=4khdddgq_%^zxnik@+=r806uok7*^@i#vho-2')

# SECURITY WARNING: don't run with debug turned on in production!
# Set DEBUG=False in production via environment variable
DEBUG = os.environ.get('DEBUG', 'True') == 'True'

# Allow all hosts in production (set specific domains in production)
